...
class ListTicketAdmin extends React.Component {
...
export default withTracker(() => {
  ...
  const subscription = Meteor.subscribe('listTicketAdmin');
  return {
    tickets: Tickets.find({}, {sort: {status: 1}}).fetch(),
    ready: subscription.ready(),
  };
})(withStyles(styles)(ListTicketAdmin));
